...
in {
  config = lib.mkIf enabled {
    programs.fish = {
      ...
      # TODO(danh): This is needed to address bug where the $PATH is re-ordered
      # by the `path_helper` tool, prioritising Apple’s tools over the ones
      # we’ve installed with nix.
      #
      # This snippet pulled from: https://github.com/LnL7/nix-darwin/issues/122#issuecomment-2272570087
